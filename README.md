...
| | |
|:---:|:---:|
| **Nmap Scan** <br> ![Nmap Scan](img/resultado_nmap.png) | **FTP Enum** <br> ![FTP Enum](img/nmap_com_sC_no_ftp_e_ssh.png) |

<br>

### Exploração Inicial de FTP (Anonymous Login)
Ao identificar que o serviço FTP permitia login anônimo, acessei o servidor para verificar os arquivos disponíveis e testar as permissões de download.

| | |
|:---:|:---:|
| **Login Anonymous** <br> ![FTP Login](img/consegui_logar_ftp_com_anonymous.png) | **Download de Arquivos** <br> ![FTP Download](img/conseugi_logar_com_ftp_e_baixar_arquivos.png) |
...
| | |
|:---:|:---:|
| **Gobuster** <br> ![Gobuster](img/resultado_do_gobuster.png) | **Web Interface** <br> ![Web Interface](img/imagem_do_site.png) |
...
| | |
|:---:|:---:|
| **FTP Upload** <br> ![FTP Upload](img/subindo_reverse_shell_pelo_ftp.png) | **Web Trigger** <br> ![Web Trigger](img/imagem_reverseshell_no_servidor.png) |
...
| | |
|:---:|:---:|
| **Iniciando Handler** <br> ![MSF Handler](img/iniciando_multi_handler.png) | **Shell Python** <br> ![Python Upgrade](img/shell_funcionou_e_melhorando_shell_com_python.png) |
...
| | |
|:---:|:---:|
| **First Flag** <br> ![First Flag](img/primeira_flag.png) | **SUID Search** <br> ![SUID Search](img/procurando_por_suid_para_escalar_priv.png) |
...
| |
|:---:|
| **PwnKit Exploit** <br> ![PwnKit Exploit](img/consegui_abusar_cve_2021_4034.png) |
| **Root Flag** <br> ![Root Flag](img/flag_root.png) |
| **User Flag** <br> ![User Flag](img/flag_user.png) |
